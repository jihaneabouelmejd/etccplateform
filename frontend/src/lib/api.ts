...
export const blApi = {
  ...
  createFromInvoice: (invoiceId: string, data?: any) => api.post(`/bl/from-invoice/${invoiceId}`, data || {}),
  ...
  deleteSignedScan: (id: string) => api.delete(`/bl/${id}/signed-scan`),
...
export const uploadApi = {
  ...
  extractLines: (filename: string) => api.get('/upload/extract-lines', { params: { filename } }),
